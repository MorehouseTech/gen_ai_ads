...
const YouTube = () => {
    ...
    const videosBeforeOrAt2020 = videos.filter(video => video.releaseYear <= 2020);
    ...
    const filteredVideos = videosBeforeOrAt2020.filter(video => 
                    ...
                    {categories.map(category => (
                        <Typography 
                            ...
                            sx={{ 
                                ...
                                color: activeCategory === category ? 'black' : '#606060',
                                '&:hover': { color: 'black' }
                            }}
