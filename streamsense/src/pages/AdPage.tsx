    ...
    return (
        <Container maxWidth="md">
            <Stack direction="row" spacing={2} sx={{ mt: 4, flexWrap: 'wrap', gap: 2 }}>
                <Avatar 
                    src={nflLogo} 
                    onClick={() => handleNavigate(title, category, "NFL")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={bbyLogo} 
                    onClick={() => handleNavigate(title, category, "Best Buy")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={amazonLogo} 
                    onClick={() => handleNavigate(title, category, "Amazon")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={ciscoLogo} 
                    onClick={() => handleNavigate(title, category, "Cisco")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={ebayLogo} 
                    onClick={() => handleNavigate(title, category, "Ebay")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={homeDepotLogo} 
                    onClick={() => handleNavigate(title, category, "Home Depot")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={thriventLogo} 
                    onClick={() => handleNavigate(title, category, "Thrivent")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={dellLogo} 
                    onClick={() => handleNavigate(title, category, "Dell")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
                <Avatar 
                    src={hebLogo} 
                    onClick={() => handleNavigate(title, category, "HEB")}
                    sx={{ width: 56, height: 56, cursor: 'pointer' }}
                />
            </Stack>
        </Container>
